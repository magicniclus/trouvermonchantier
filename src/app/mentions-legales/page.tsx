...
const page = () => {
    return (
      ...
      <div className="text-gray-700">
        <p className="mt-2">
          trouver-mon-chantier.com est la propriété de l’entreprise Nicolas CASTERA
          , gérée par Monsieur Nicolas CASTERA.
        </p>
        ...
        <p className="mt-2">
          ...
          interdiction s’étend, sans que cette liste ne soit limitative, à tout
          élément rédactionnel figurant sur le site : présentation des écrans,
          textes, logos, photographies notamment.
        </p>
        <h2>Cookies</h2>
        <p className="mt-2">
          ...
          navigation de celui-ci sur le site Internet. Le paramétrage de votre
          logiciel de navigation permet d’informer de la présence de cookies et
          éventuellement de la refuser selon la procédure décrite par la CNIL.
        </p>

        <h3 className="text-lg mt-3 font-semibold">Que sont les cookies ?</h3>
        <p className="mt-2">
          Un « cookie » est un fichier de texte envoyé par les sites Internet à
          l’ordinateur ou à un autre périphérique connecté à Internet d’un
        ...
        <p className="mt-2">
          Ces cookies sont indispensables pour mener à bien une demande que vous
          aurez effectuée. Les exemples incluent la mémorisation des
        ...
        <p className="mt-2">
          ...
          avantageuses. Par exemple, les cookies fonctionnels permettent au site
          Internet de se souvenir de vos paramètres spécifiques, comme la
          sélection de votre région et votre état de connexion permanente en cas
          de sélection, et affiche les précédents biens consultés, et d’autres
        ...
        <p className="mt-2">
          ...
          performance et la navigation au sein de celui-ci. Ces cookies peuvent
          être fournis par notre fournisseur d’outil analytique de tierce
          partie, mais ne sont utilisés qu’à des fins liées à nos sites
          Internet.
        </p>
        ...
        <ul>
          <li>
            ...
            exemple en remplissant un formulaire ou lorsque vous nous soumettez
            des demandes d’informations et des commentaires.
          </li>
          <li>
            ...
            cookies » ou traceurs installés sur votre terminal et notamment des
            informations relatives à vos visites telles que votre adresse IP,
            votre fournisseur de services Internet, le type de navigateur que
            vous utilisez, votre système d’exploitation, les pages du site que
            vous avez visitées, la date et l’heure d’accès, ou encore des
            ...
            données résultants de l’analyse de votre profil, les données issues
            de l’utilisation des services telles le temps de connexion, le temps
            d’utilisation.
          </li>
        </ul>
        <p className="mt-2">
          Nous sommes également susceptibles de vous demander des informations
          si vous nous faites part d’un problème concernant notre site ; si vous
          nous contactez, nous sommes susceptibles de conserver une trace de
          cette correspondance.
        </p>
        <p className="mt-2">
          Les informations obligatoires (notamment vos noms, prénom, adresse et
          e-mail) doivent être saisies dans les champs des formulaires de
        ...
        <ul>
          ...
          <li>
            ...
            l'utilisation de notre site et personnaliser votre expérience selon
            vos intérêts et besoins.
          </li>
          <li>
            Réaliser (de manière anonyme) des statistiques sur l'activité du
            site pour mesurer la satisfaction et la qualité de services et
        ...
        <p className="mt-2">
          ...
          38 et suivants de la loi "Informatique et Libertés"). Pour l'exercer,
          l'utilisateur peut s'adresser aux propriétaires du site via la page
          contact.
        </p>
        ...
        <p className="mt-2">
          ...
          efficace alliant identifiant et mot de passe, ainsi que des
